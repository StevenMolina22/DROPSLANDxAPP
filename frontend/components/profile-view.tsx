...
export default function ProfileView({
  ...
  const { balance, donated, userData, isArtist, logout, isNFIDUser, user } =
    useAuth(); // Get user data and check if artist
  ...
  const avatarSrc =
    username === "iamjuampi" ? "/avatars/juampi.jpg" : "/avatars/user.jpg";
      ...
      <div className="pb-6 bg-gray-950">
        ...
        <div className="mt-6">
          <Tabs defaultValue={isArtist() ? "posts" : "artists"}>
            <TabsList
              className={`grid w-full px-4 bg-gray-800 ${isArtist() ? "grid-cols-3" : "grid-cols-3"}`}
            >
              {isArtist() ? (
                <>
                  <TabsTrigger
                ...
                <Card key={index} className="bg-gray-800 border-gray-700">
                  <CardContent className="p-4">
                    ...
                    <div className="flex items-center justify-between text-gray-400 text-sm">
                      ...
                      <button
                        className="flex items-center"
                        onClick={() => handleOpenComments(index)}
                      >
                        <MessageCircle className="h-4 w-4 mr-1" />
                        {post.comments +
                          (postComments[`profile-${index}`]?.length || 0)}
                      </button>
                ...
                {rewards.length === 0 && (
                  <div className="text-center py-8 bg-gray-800 rounded-lg border border-gray-700">
                    ...
                    <p className="text-gray-400 text-sm mt-1">
                      Buy tokens from your favorite artists to receive exclusive
                      rewards
                    </p>
              ...
              <TabsContent value="tracks" className="px-4 mt-4 space-y-3">
                ...
                {userTracks.length === 0 && (
                  <div className="text-center py-8 bg-gray-800 rounded-lg border border-gray-700">
                    ...
                    <p className="text-gray-400 text-sm mt-1">
                      Start building your music collection by saving your
                      favorite tracks
                    </p>
                    <Button className="mt-4 bg-bright-yellow hover:bg-bright-yellow-700 text-black">
                      Explore Music
          ...
          <DialogContent className="bg-gray-800 border-gray-700">
            ...
            <div className="space-y-4">
              {currentPostIndex !== null &&
                postComments[`profile-${currentPostIndex}`]?.map(
                  (comment, index) => (
            ...
            <TabsContent value="tracks" className="px-4 mt-4 space-y-3">
              ...
              {userTracks.length === 0 && (
                <div className="text-center py-8 bg-gray-800 rounded-lg border border-gray-700">
                  ...
                  <p className="text-gray-400 text-sm mt-1">
                    Start building your music collection by saving your favorite
                    tracks
                  </p>
                  <Button className="mt-4 bg-bright-yellow hover:bg-bright-yellow-700 text-black">
                    Explore Music
